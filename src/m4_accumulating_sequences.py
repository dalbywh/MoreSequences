...
def rectangles_from_circles(circles):
    ...
    sequence = []
    for k in circles:
        top_left = rg.Point((k.center.x - k.radius), (k.center.y - k.radius))
        bottom_right = rg.Point((k.center.x + k.radius), (k.center.y +
                                                         k.radius))
        sequence = sequence + [rg.Rectangle(top_left,bottom_right)]
    return sequence
